class OPT_TRAIN:
    def __init__(self, data='data/select_50k_S2R/select_50k_S2R', reverse=False):
        self.accum_count = 4
        ...
        self.save_model = 'experiments/checkpoints/select_50k_S2R/select_50k_S2R_model'
        self.seed = 42
        ...
        if reverse:
            data = 'data/select_50k_S2R-reverse/select_50k_S2R-reverse'
            self.data = data
